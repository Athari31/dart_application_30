...
// while (true){
//   print('Welcome to the translation system from Arabic to English');
//   print('To enter a word, press 1, to enter a sentence, press 2, to exit, press 3 ');
...
//    String? Words = translateWord(userInput, englishToArabic);
...
//     case "2":
//       print("Enter a word or sentence in English: ");
//       String userInput = stdin.readLineSync()!;
//       translateEnglishWords(userInput);
...
//     const english = ["Hello","How are you","Welcome","Yes"];
//     const arabic = ["أهلا وسهلا","كيف حالك","مرحبا","نعم"];
